        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            (e.id = 'bmc-wbtn'),
                ...
                'left' == s.dataset.position
                    ? (e.style.left = s.dataset.x_margin + 'px')
                    : (e.style.right = s.dataset.x_margin + 'px'),
                (e.style.bottom = s.dataset.y_margin + 'px'),
                (e.style.boxShadow = '0 4px 8px rgba(0,0,0,.15)'),
                (e.innerHTML =
                    '<img src="' +
                    '/images/major.png' +
                    '" alt="Buy Me a Coffee" style="height: 100%; border-radius: 100%; width: 100%; margin: 0; padding: 0;">'),
                (e.style.zIndex = '9999'),
            ...
            a.setAttribute('id', 'bmc-iframe'),
                ...
                t.matches
                    ? ('left' == s.dataset.position
                          ? (a.style.left = s.dataset.x_margin + 'px')
                          : (a.style.right = s.dataset.x_margin + 'px'),
                      (a.style.bottom =
            ...
            (o.style.position = 'fixed'),
                'left' == s.dataset.position
                    ? (o.style.left =
                          parseInt(s.dataset.x_margin, 10) + 84 + 'px')
                    : (o.style.right =
                          parseInt(s.dataset.x_margin, 10) + 84 + 'px'),
            ...
            (e.onclick = function() {
                r ||
                    (a.src =
                        ...
                        s.dataset.id +
                        '?description=' +
                        encodeURIComponent(s.dataset.description) +
                        '&color=' +
